...
func (r *mutationResolver) CreateTodo(ctx context.Context, input NewTodo) (string, error) {
	...
	id := CreateUniqueID()
	log.Printf("[mutationResolver.CreateTodo] str_id: %d", id)
...
func (r *mutationResolver) CreateUser(ctx context.Context, input NewUser) (string, error) {
	...
	id := CreateUniqueID()
	log.Printf("[mutationResolver.CreateTodo] str_id: %#v", id)
...
func (r *todoResolver) Text(ctx context.Context, obj *models.Todo) (string, error) {
	// panic("not implemented")
	log.Printf("[todoResolver.Text] id: %#v", obj)
